...
public class SupprimerClient extends javax.swing.JFrame {
    ...
    private void getcombox() {
        ...
        jComboBox1.addItem("choidir client ");
        try {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "choisir client" }));
        getcombox();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(SupprimerClient.class.getName()).log(Level.SEVERE, null, ex);
        }
